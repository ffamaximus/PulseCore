...
`PulseCore` provides a small, focused set of abstractions designed to simplify the modeling of domain-centered applications without introducing infrastructure or framework dependencies. It aims to be a high-performance, foundational library for building robust and scalable systems.
...
```csharp
using PulseCore.Application.Mediator;
